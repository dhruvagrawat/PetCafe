...
const ContactUs = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send("xxxx", "xxxx", templateParams, "xxxx")
      .then((response) => {
        ...
        <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Roboto:400,500,700&display=swap"/>
          ...
          <div className="first">
            <div className="innerfirst">
              ...
              <a href="https://dhruvagrawat.live" target="_blank" rel="noopener noreferrer">
          ...
          <div>
            ...
            <div className="callcon">
              <h3 className="callsec"> <b>🐾  Call Us: +91-XXXXXXXX  🦴</b></h3>
            </div>
            <div className="grid">
              <div>
              ...
              <div className="innergrid">
                <div className="innerin">
                  ...
                  <div className="mail">
                    ...
                    <p><b>Mail</b><br></br>
                      <a href="contact@dhruvagrawat.com">c\Contact@dhruvagrawat.com</a>
                    </p>
                  </div>
                </div>
